...
Figure~\ref{fig:syntax} also presents the 
syntax of {\em contracts} to keep all essential definitions grouped together, but in this section we will only focus on the language and its semantics. In Section~\ref{sect:contracts} we return to the syntax and semantics of contracts.
...
also includes the syntax of formulae that will appear in the image of
our translation. It is just the standard connectives of first-order
logic plus a predicate $\lcf{t}$ to represent crash-freedom, and whose

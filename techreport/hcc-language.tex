...
definition, and (iii) constructors are fully applied.  These
constraints do not restrict expressiveness; lambda-lifting,
@case@-lifting, and eta-expansion respectively can easily transform a
program with nested constructs and partially-applied constructors into
our restricted form, and our working prototype relies on just such
transformations.  However this simpler language is instead extremely
...
\kc{This is only going to hold from right to left}

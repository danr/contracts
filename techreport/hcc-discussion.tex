...
From a practical point of view this is not very good: After all, there exists a very simple 
...
This is a challenging (but essential) directions for future work, and we are currently 
...
uses for generating finite counterexamples in Isabelle. \dv{Someone please check!}. If
the theory can guarantee the existence of a finite model in case of a counterexample,
a finite model checker such as Paradox~\cite{paradox} will be able to return back one.

...
A base contract $\{x \mid e\}$ is satisfied by a diverging
computation, or by a computation that causes the predicate $e$ to diverge
...
Interestingly, our formalisation is not complete -- $D_\infty$ has a complex structure 

...
whereas the second axiom asserts that a constructor value is crash-free if all of its
childre nodes are crash-free. 
...
\begin{theorem} Assume that $e$ and $\Ct$ contain no term variables. Then, if
$\ctrans{}{\cdot}{e \in \Ct} = \formula{\phi}$, it is the case 
that $\langle D_\infty,{\cal I}\rangle \models \phi$.
\end{theorem} 
\begin{theorem} The axiomatization of crash-freedom is true in the denotational model, that is, $\langle D_\infty,{\cal I}\rangle \models \Th_\lcfZ$.
\end{theorem}

...
\dr{If we have little space we can move function definitions to the
  appendix (applies to all definitions in this section of course)
}:
...
The @c_head@ definition is our statement expressing the contract
\[

...
code.  Functional programmers often have to introduce assertions to 
ensure that their code is crash-free.  In this work we allow programmers 
to express assertions as contracts, whose validity we can check statically. 
...
all justified by denotational semantics. This translation enables us prove 

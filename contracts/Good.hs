...
unsat_juggle_id_cf     = id    ::: CF :&: Pred id  --> Pred id
unsat_juggle_not_cf    = not   ::: CF :&: Pred not --> Pred id
...
unsat_juggle_id        = id    ::: Pred id  --> Pred id
unsat_juggle_not       = not   ::: Pred not --> Pred id
unsat_bad_unjuggle_id  = id    ::: Pred not --> Pred not
unsat_bad_unjuggle_not = not   ::: Pred id  --> Pred not
